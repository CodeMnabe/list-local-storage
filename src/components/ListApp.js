...
class ListApp extends Component {
  ...
  componentDidMount = () => {
    const getData = this.props.read && this.props.read("shopping-list");
    this.setState({
  ...
  componentDidUpdate = prevProps => {
    if (prevProps.task !== this.props.task && this.props.task !== "") {
      ...
      this.props.save && this.props.save("shopping-list", updatedList)
    }
  };
  remove = id => {
    ...
    this.props.save && this.props.save("shopping.list", newList)
  };
  render = () =>
